...
every pack, or `python3 tools/validate-release.py` to check all release packs and
the source fingerprint together. Run `python3 tools/test-validation.py` after
changing a validator. Confirm every locale has an editorial review, all source-catalog
